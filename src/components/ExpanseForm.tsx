...
const ExpanseForm = ({onSubmit}:Props) => {
   const {register,handleSubmit,reset,formState:{errors}} = useForm<ExpanseFormData>({resolver: zodResolver(schema)})
  return (
...
</select>
{
        ...
        <input {...register('amount',{valueAsNumber: true})} id="amount" type="Number" placeholder="Amount" className="form-control input input-bordered w-full max-w-xs p-2 m-2" />
        {
